...
<div
  ...
  <div class="mx-auto my-8">
    ...
    <p class="m-6 text-white font-extrabold text-4xl">
      Play Games with your Loot and get XP!
    </p>
  </div>

  <p class="mx-8 mb-3">XP (for Adventurers) is a XP system built for <a href="https://lootproject.com">Loot</a></p>
  <p class="mx-8">Each Loot has now an associated XP score. See <a class="underline" href={`https://etherscan.io/address/${contractsInfo.contracts.LootXP?.address}`}>contract</a></p>
  ...
  <p class="mx-8">In order to ensure XP sournces and sync and logically sound, the Loot XP sources (Game that can generate XP is governed by a DAO.</p>

  <p class="mx-8 mt-8">Come have a chat on our Discord server!</p>
  <a href="https://discord.gg/yrRSNNCysZ" target="_blank" class="mx-auto block w-min discord" >
  ...
  <div class="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8">
    <div class="mt-8 border-t border-gray-700 pt-8 md:flex md:items-center md:justify-between">
      <div class="flex space-x-6 md:order-2">
        ...
        <a href="https://twitter.com/lootgodsDAO" target="_blank" class="text-gray-400 hover:text-gray-300">
        ...
        <a href="https://github.com/wighawag/lootxp"  target="_blank" class="text-gray-400 hover:text-gray-300">
        ...
        <a href="https://discord.gg/yrRSNNCysZ" target="_blank" class="text-gray-400 hover:text-gray-300">
